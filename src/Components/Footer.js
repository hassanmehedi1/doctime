   ...
   return (
     <>
       <div className=" py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
         <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-6 gap-4">
           <div className="flex flex-col flex-shrink-0">
             <div>
               <a href="/" className="font-bold text-xl titleFoot1 text-start">
                 Doc<span className="titleFoot2 text-start">mic.</span>
               </a>
             ...
             <div className="flex items-center justify-center gap-x-4 mt-6">
               <div className=" w-8 h-8 flex-shrink-0 cursor-pointer bgIcon rounded-full flex items-center justify-center">
                 <svg
                   width="18"
                   height="17"
                   viewBox="0 0 18 17"
               ...
               <div className=" w-8 h-8 flex-shrink-0 cursor-pointer bgIcon border border-blue-500 shadow-xl rounded-full flex items-center justify-center">
                 <svg
                   width="18"
                   height="17"
                   viewBox="0 0 18 17"
             ...
             <p className="text-sm leading-none text-gray-800 mt-4">
               Copyright @2022 Medicom All Rights Reserved
             </p>
           </div>
           <div className="sm:ml-0 ml-8">
             <h2 className="text-base font-semibold leading-4 textFooter ">
               Quick Links
             </h2>
           ...
           <div>
             <h2 className="text-base leading-4 ">Services</h2>
             <p className="hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 cursor-pointer">
               Our Doctors
             </p>
             <p className="hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 cursor-pointer">
           ...
           <div className="sm:ml-0 ml-8">
             ...
             <p className="titleFoot1 text-base leading-4 mt-6  cursor-pointer text-end">
               Mon- Tue
               <span className="text-black"> 08:00 AM- 05:00 PM</span>
             </p>
             <p className="titleFoot1 text-base leading-4 mt-6  cursor-pointer text-end">
               Wed- Thu
               <span className="text-black"> 09:00 AM- 06:00 PM</span>
             </p>
             <p className="titleFoot1 text-base leading-4 mt-6  cursor-pointer text-end md:mr-4">
               Fri- Sat
               <span className="text-black"> 10:00 AM- 07:00 PM</span>
             </p>
             <p className="titleFoot1 text-base leading-4 mt-6  cursor-pointer text-end md:mr-10">
               Sunday
               <span className="text-black"> Emergency Only</span>
             </p>
             <p className="titleFoot1 text-base leading-4 mt-6  cursor-pointer text-end md:mr-10">
               Personal
               <span className="text-black"> Mon- 05:00 PM</span>
             </p>
           </div>
         </div>
       </div>
